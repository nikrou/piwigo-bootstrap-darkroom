{combine_css path="themes/simple-responsive/admin/css/admin.css"}
...
<form method="post" class="properties">
	...
	<div id="appearance" class="tab-content current">
            <div class="fieldset">
		<h3>{'Bootstrap theme'|translate}</h3>
		<p>
		    <label labelfor="bootstrap_theme">{'Color theme'|translate}</label>
		    <select name="bootstrap_theme" class="custom-select">
		...
		<p>
		    ...
		    <select id="bootswatch_theme" class="custom-select" name="bootswatch_theme"></select>
		</p>
		...
		<p>
            ...
            <div class="fieldset">
		<h3>{'Custom CSS'|translate}</h3>
		<textarea class="form-control" name="custom_css" cols="80" rows="10">{if $theme_config->custom_css}{$theme_config->custom_css}{/if}</textarea>
            </div>
	</div>
...
preview.html('<img src="../themes/simple-responsive/components/bootswatch/' + select_bootswatch.val() + '/thumbnail.png" width="50%" style="padding: 10px 0;"/>');
preview.show();
...
preview.html('<img src="../themes/simple-responsive/admin/img/' + $('select[name=bootstrap_theme]').val() + '.png" style="padding: 10px 0;"/>');
preview.show();
}
